...
class Modifybooking extends StatefulWidget {
  final id;
  Modifybooking({super.key, required this.apartment, this.id});
  final Booking apartment;
  @override
  State<Modifybooking> createState() => _ModifybookingState();
}

class _ModifybookingState extends State<Modifybooking> {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<UserCubit, UserState>(
        listener: (context, state) {
          if (state is ModifyBookingSuccess) {
          ...
          } else if (state is ModifyBookingFailure) {
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.apartment.apartment.title,
